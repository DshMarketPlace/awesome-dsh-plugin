...
[![插件数量](https://img.shields.io/badge/插件-2348+-success?style=flat-square)](https://dshmarketplace.dev/zh)
...
**DSH 插件市场**索引了完整的 DeepSeek Harness 插件生态 — 目前已收录 2348+ 个插件。
...
访问 **[dshmarketplace.dev](https://dshmarketplace.dev/zh)** 探索全部 2348+ 个已索引插件，支持：
- 高级搜索和筛选
- 安装验证状态
- 详细插件页面
- 分类和排行榜
...
- [dsh-commandcode-provider](https://github.com/Mars-Sea/dsh-commandcode-provider) — 非官方 Command Code 模型接入插件：注册 `commandcode` 路由，带实时模型目录与推理强度支持。 ★0k · [详情](https://dshmarketplace.dev/plugins/mars-sea-dsh-commandcode-provider)
...
- [dsh-undo-plugin](https://github.com/lire1131/dsh-undo-plugin) — DSH 撤销/回退系统：配置变更自动存档，一键撤销/恢复/回退到任意版本，支持 WebUI 与离线 CLI/GUI 工具（DSH 启动失败也能救）。 ★0.1k
...
- [deep-whale-day-night-theme](https://github.com/GGBond2424648901/deep-whale-day-night-theme) — 鲸鱼娘昼夜皮肤：白昼水晶工坊与夜晚月潮观测室双场景，成对角色、Q 版侧栏宠物、花边与气泡/星点轻量氛围。 ★0.1k
...
- **[DSH 插件市场](https://github.com/DshMarketPlace/dshmarketplace)** — 完整的 2348+ 插件目录
